package ec.edu.ups.icc.fundamentos01.products;
...
public class ProductController {
    ...
    // ============== PRODUCTOS POR USUARIO CON PAGINACIÓN ==============
    ...
    public ResponseEntity<Page<ProductResponseDto>> findByUserIdWithFilters(
